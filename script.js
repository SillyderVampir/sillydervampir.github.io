...
function rollDie(currentPlayer){
    ...
    showDice.src=`media/dice_white_${roll}.png`;
...
function updateDiceVisuals(){
    ...
    showDice.src = "media/dice_empty.png";
    ...
    for (p = 0; p < 2; p++){
        for (r = 0; r < 3; r++){
            ...
            for (d = 0; d < 3; d++){
                ...
                diceVal = field[p][r][d];
                if (diceVal === 0){
                    currDice.src = "media/dice_empty.png";
                } else {
                    currDice.src = `media/dice_${diceColouring[d]}_${diceVal}.png`;
                };
            };
        };
    }; 
...
function showResults(){
    ...
    resultScreen.style.backgroundImage =`url(media/win_screen_${result}.png`;
    if (result === "draw"){
        resultScreen.style.backgroundImage =`url(media/win_screen.png`;
    };
    ...
    if (running){
        ...
        if (!(currentPlayer != rowPlayer || (currentPlayer === 2 && opponentType != "player"))){
            if (field[rowPlayer-1][rowIndex-1].includes(0)){
                ...
                currRow.style.backgroundImage = "url(media/selection_valid.png)";
            } else {
                // highlight black if no die can be placed
                currRow.style.backgroundImage = "url(media/selection_invalid.png)";
            };
        };
    };
};
...
function rowLeave(row){
    let currRow = document.getElementById(`row${row}`)
    currRow.style.backgroundImage = "url(media/selection_none.png";
};
...
restartBtn.addEventListener("mouseover", function(){
    restartBtn.style.backgroundImage = "url(media/button_new_game_hover.png)";
});
// stop highlighting if mouse leaves button
restartBtn.addEventListener("mouseleave", function(){
    restartBtn.style.backgroundImage = "url(media/button_new_game.png)";
});
...
playButton.addEventListener("mouseover", function(){
    if (musicPlaying){
        ...
        playButton.style.backgroundImage = "url(media/button_music_hover.png)";
    } else {
...
playButton.addEventListener("mouseleave", function(){
    if (musicPlaying){
        ...
        playButton.style.backgroundImage = "url(media/button_music.png)";
    } else {
...
selectBtn.addEventListener("click",function(){
    ...
    if (validInput){
        ...
        if (opponentType === "player"){
            ...
            avatarP2.src = "media/player_2.png"
        } else {
            nameP2.innerHTML = inputText;
            avatarP2.src = "media/player_2_robot.png"
        };
...
selectBtn.addEventListener("mouseover", function(){
    selectBtn.style.backgroundImage = "url(media/button_confirm_hover.png)";
});
// stop highlighting if mouse leaves button
selectBtn.addEventListener("mouseleave", function(){
    selectBtn.style.backgroundImage = "url(media/button_confirm.png)";
});
...
creditsBtn.addEventListener("mouseover", function(){
    creditsBtn.style.backgroundImage = "url(media/button_credits_hover.png)";
});
// stop highlighting if mouse leaves button
creditsBtn.addEventListener("mouseleave", function(){
    creditsBtn.style.backgroundImage = "url(media/button_credits.png)";
});
...
function botCheater(){
    ...
    roll = 6
    showDice.src=`media/dice_white_6.png`;
    // get the amount of full rows
    let botOptions = "";
    for (r = 0; r < 3; r++){
        let rowFull = true;
